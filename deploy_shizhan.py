...
def conditional_run(now):
    ...
    if now.time() == seven_am.time():
        ...
        df1, df2 = run_model('long_term_forecast_a', 'Overall_re', './dataset/Overall/', 'Overall_re.csv', 192, 17, 4,
                             4, 4,
                             '2023-01-01 00:00:00',
                             now, 1)
        ...
        df1, df2 = run_model('long_term_forecast_b', 'Overall_merge', './dataset/Overall/', 'Overall_merge_30min.csv',
                             96, 1, 4, 4, 4,
                             '2024-09-13 20:34',
                             '2024-09-19 18:10:00', 0)  # 使用当前时间减去一分钟作为结束时间
        '''
        ...
        output_csv = 'predicted_zero_imputation.csv'  # 输出文件路径
