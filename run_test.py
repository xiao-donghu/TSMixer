...
#######itr后面为新增加的属性
def run_model(task_name=None, data=None, root_path=None, data_path=None, seq_len=None, pred_len=None, start_time=None,
              end_time=None, itr=None,d_model =None,d_ff = None,activation =None,patience = None,learning_rate =None,train_epochs =None):
    # Fix seed
    ...
    if pred_len == 1:
        ...
        df['window_start'] = pd.to_datetime(df['window_start'],format='%d/%m/%Y %H:%M:%S')
    ...
    parser.add_argument('--data_path', type=str, default='Overall_merge.csv', help='data file')
    ...
    if args.is_training:
            ...
            for ii in range(args.itr):
                ...
                setting = '{}_{}_{}_{}_ft{}_{}_{}_sl{}_ll{}_pl{}_in{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}_pc{}_lr{}_ep{}'.format(
                    args.task_name,
                    args.model_id,
                    args.model,
                    args.data,
        ...
        args.seq_len = seq_len  # Set the current seq_len value
        print(f"Using seq_len={seq_len}")  # Add this line to print the current seq_len
        setting = '{}_{}_{}_{}_ft{}_{}_{}_sl{}_ll{}_pl{}_in{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}_pc{}_lr{}_epoch{}'.format(
            args.task_name,
                args.model_id,
                args.model,
                args.data,
